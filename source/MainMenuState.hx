...
{
	public static var psychEngineVersion:String = '0.2.0'; //For Discord RPC, Current Version, and more...
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Kysiki Engine v" + psychEngineVersion, 12);
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									...
									case 'changelog':
										LoadingState.loadAndSwitchState(new ChangeLogMenu());
								}
							});
						}
					});
